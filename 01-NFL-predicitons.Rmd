...
We let the last column be all equal to 1 to represent the effect for home field advantage.  We let the a last row be equal to 1 to make the matrix have full column rank and center the team effect estimates at 0.  The response, $w$, is a binary vector of length $N$ where $w_i = 1$ if the home team won game $i$ and $w_i = 0$ otherwise.  We use the logit link function, meaning that we assume
